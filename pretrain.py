...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_path', default='', type=str,help='path to pretrained SSL checkpoint')
    ...
    if params.pretrained_path and os.path.isfile(params.pretrained_path):
        print(f"==> Loading pretrained checkpoint from {params.pretrained_path}")
        model = load_model(model, params.pretrained_path)
