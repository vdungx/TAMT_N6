...
parser.add_argument('--dataset', default='mini_imagenet', choices=['Rareact2','Rareact', 'k400','ucf101','hmdb51','tiered_imagenet', 'SSv2Full','SSv2Small','diving48'])
...
# parser.add_argument('--n_query', default=1, type=int, help='number of unlabeled data in each class during meta validation')

parser.add_argument('--test_n_episode', default=500, type=int, help='number of episodes in test')
